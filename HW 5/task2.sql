...
SELECT AVG(bill_total) AS 'Average_Bill' FROM restBill WHERE table_no=2;
...
SELECT COUNT(DISTINCT table_no) AS 'Distinct_Tables' FROM restBill WHERE waiter_no IN (4, 2);
